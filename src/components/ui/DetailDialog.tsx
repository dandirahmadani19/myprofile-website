  ...
  const formatContent = (text: string) => {
    return text.split("\n").map((line, index) => {
      ...
      if (trimmedLine.startsWith("•") || trimmedLine.startsWith("-")) {
        ...
        if (colonIndex > 0 && colonIndex < 40) {
          ...
          return (
            ...
            >
              <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[#ff6b00]/20 flex items-center justify-center mt-0.5">
                <FaArrowRight className="text-[#ff6b00] text-[10px]" />
              </span>
              <span>
        ...
        return (
          ...
          >
            <span className="flex-shrink-0 mt-1">
              <FaCheckCircle className="text-[#ff6b00] text-sm" />
            </span>
      ...
      if (trimmedLine.startsWith("Key ") || trimmedLine.startsWith("Impact:")) {
        return (
          <h4 key={index} className="text-[#ff6b00] font-bold text-sm mt-5 mb-3 flex items-center gap-2 border-b border-[#1a1a1a] pb-2">
            ...
            <div className="p-4 md:p-6 border-b border-[#1a1a1a] bg-[#0a0a0a]/50">
              <div className="flex items-start justify-between">
                <div className="flex-1 pr-4">
                  ...
                  {subtitle && (
                    <p className="text-[#888] text-sm md:text-base mt-1">{subtitle}</p>
                  )}
                ...
                <button
                  onClick={onClose}
                  className="p-2 text-[#666] hover:text-[#ff6b00] hover:bg-[#ff6b00]/10 rounded-lg transition-all"
            ...
            <div className="flex-1 overflow-y-auto p-4 md:p-6">
              ...
              {impact && (
                <motion.div 
                  ...
                  className="mt-6 p-4 bg-gradient-to-r from-[#ff6b00]/10 to-transparent border-l-2 border-[#ff6b00] rounded-r-lg"
                >
                  <p className="text-[#ff6b00] font-bold text-sm mb-1 flex items-center gap-2">
